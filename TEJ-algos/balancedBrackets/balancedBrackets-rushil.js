...
function hasBalancedBrackets(inputString) {
  ...
  var brackets = [];
  if (!inputString.length || !inputBrackets.length) return true; //empty input or no brackets i.e. 'balanced' (throwing an error is fine also)
...
console.log(hasBalancedBrackets("text ( is allowed ){rwwrwrrww [] ()}"));
